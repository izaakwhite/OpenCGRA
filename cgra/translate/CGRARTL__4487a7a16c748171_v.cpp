//========================================================================
// VCGRARTL__4487a7a16c748171_v.cpp
//========================================================================
...
#include "obj_dir_CGRARTL__4487a7a16c748171/VCGRARTL__4487a7a16c748171.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CGRARTL__4487a7a16c748171/VCGRARTL__4487a7a16c748171__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VCGRARTL__4487a7a16c748171_t;

  // Exposed methods
  VCGRARTL__4487a7a16c748171_t * create_model( const char * );
  void destroy_model( VCGRARTL__4487a7a16c748171_t *);
  void eval( VCGRARTL__4487a7a16c748171_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VCGRARTL__4487a7a16c748171_t *, char * );
  #endif
...
VCGRARTL__4487a7a16c748171_t * create_model( const char *vcd_filename ) {

  VCGRARTL__4487a7a16c748171_t * m;
  VCGRARTL__4487a7a16c748171   * model;

  Verilated::randReset( 0 );

  m     = (VCGRARTL__4487a7a16c748171_t *) malloc( sizeof(VCGRARTL__4487a7a16c748171_t) );
  model = new VCGRARTL__4487a7a16c748171();
...
void destroy_model( VCGRARTL__4487a7a16c748171_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCGRARTL__4487a7a16c748171 * model = (VCGRARTL__4487a7a16c748171 *) m->model;
...
void eval( VCGRARTL__4487a7a16c748171_t * m ) {
...
#if VLINETRACE
void trace( VCGRARTL__4487a7a16c748171_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_CGRARTL__4487a7a16c748171__v );
