#=========================================================================
# VCGRARTL__4487a7a16c748171_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# CGRARTL__4487a7a16c748171
#-------------------------------------------------------------------------

class CGRARTL__4487a7a16c748171( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libCGRARTL__4487a7a16c748171_v.so', os.path.getmtime( './libCGRARTL__4487a7a16c748171_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libCGRARTL__4487a7a16c748171_v.so')

    # increment instance count
    CGRARTL__4487a7a16c748171.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "CGRARTL__4487a7a16c748171.verilator1.vcd"
    ...
    s.recv_wopt = [ RecvIfcRTL( CGRAConfig_6_4_6_8 ) for _ in range(4) ]
